    ...
    <div class="whitepaper" bind:clientWidth={width}>
        ...
        <div class="body">
            ...
            <p class="blurb">
                ...
                <WhitepaperExternalLink href="https://wiki.internetcomputer.org/wiki/Maturity_modulation"
                ...
                proportion of total token supply that is generated annually for voting rewards is 5%.
            ...
            <p class="blurb">
                ...
                >maturity</WhitepaperExternalLink>. At the point a neuron’s 
                maturity is disbursed it is burned and the corresponding value of CHAT tokens will be 
                minted by the SNS ledger to an account.  It is also possible for the SNS to mint tokens 
                by proposal although it is unlikely the OpenChat DAO will elect to do this.
            </p>
